                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="datepicker1" name="date_1" data-date-format="yyyy-mm-dd" autocomplete="off">
                            </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="datepicker2" name="date_2" data-date-format="yyyy-mm-dd" autocomplete="off">
                            </div>
   ...
   <td align="right">'.'₱ '.number_format($row->subtotal, 2, '.', ', ').'</td>
     ...
     <td align="right">'.'₱ '.number_format($row->total, 2, '.', ', ').'</td>
      <td align="right">'.'₱ '.number_format($row->paid, 2, '.', ', ').'</td>
       <td align="right">'.'₱ '.number_format($row->due, 2, '.', ', ').'</td>
