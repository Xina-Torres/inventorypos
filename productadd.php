...
if($f_extension=='jpg' || $f_extension=='jpeg' ||  $f_extension=='png' || $f_extension=='gif' || $f_extension=='JPG' || $f_extension=='JPEG' || 
    ...
    ?>
                      ...
                      ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min=".001" step=".001" class="form-control" name="txtpprice" placeholder="Enter..." required>
                        </div>

                        <div class="form-group">
                            <label>Sale price</label>
                            <input type="number" min=".001" step=".001" class="form-control" name="txtsaleprice" placeholder="Enter..." required>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Stock</label>
                            <input type="number" min=".001" step=".001" class="form-control" name="txtstock" placeholder="Enter..." required>
                        </div>
